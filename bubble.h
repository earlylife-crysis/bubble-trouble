//Header File modified by Yashas M Salian, 210070095
...
public:
    ...
    {
        // move the bubble
        vy = vy + 50.0 * t; // Introducing Gravity
        ...
        if(new_y > 440.0 - circle.getRadius()) //440 is the bottom of the playing area
        {
            vy = -vy;
